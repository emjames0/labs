...
var availableSeats = 14;
console.log("The number of seats left on this plane are " +availableSeats)

console.log("Step 2:  Cost of Groceries");
var groceryTotal = 936.52;
console.log("The total dollar amount for groceries is " +groceryTotal)

console.log("Step 3:  Middle Initial");
var middleInitial = "O"; 
console.log("The customer's middle initial is " +middleInitial)

console.log("Step 4:  Is it Hot Outside?");
var isHotOutide = true;
console.log("Is it hot outside? " +isHotOutide)
...
var streetAddress = "1234 Cherry Lane"; 
...
//  ↓ YOUR CODE HERE ↓
console.log("The number of seats aleft on this plane are " + (availableSeats - 2))

    console.log('Buy a Candy Bar:')
//	Impulse candy bar purchase! Add 2.15 to the grocery total
//  ↓ YOUR CODE HERE ↓
console.log("The grocery total went up to " +(groceryTotal + 2.15))

    console.log('Fix a Birth Certificate:')
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
middleInitial = "T"
console.log("The middle initial has been changed to " +middleInitial)
...
//  ↓ YOUR CODE HERE ↓
var fullName = firstName + middleInitial + " Richardson"
