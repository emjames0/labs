...
//Answer: You can manipulate CSS styles, attributes, classes, add/remove events, change values, etc. 
...
//Answer: Honestly, I think I prefer CSS only because my understanding of CSS seems to be much deeper. As I build an understanding with JavaScript, I might change my mind. 
...
td4.style.backgroundColor = '#f9f9f9';
...
//Answer: I would think this is primarily due to the dynamic nature of being able to alter code without having to go back to the original HTML files. 
